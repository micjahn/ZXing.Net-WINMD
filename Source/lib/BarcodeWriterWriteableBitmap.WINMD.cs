...
namespace ZXing
{
   ...
   /// The result is a WriteableBitmap Image object
   /// </summary>
   public sealed class BarcodeWriterWriteableBitmap : IBarcodeWriterWriteableBitmap
   {
      ...
      /// </summary>
      public IBarcodeRendererWriteableBitmap Renderer { get; set; }
      ...
      /// <returns></returns>
      internal WriteableBitmap Write(BitMatrix matrix)
      {
         if (Renderer == null)
         {
            throw new InvalidOperationException("You have to set a renderer instance.");
